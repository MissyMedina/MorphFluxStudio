// MorphFlux Studio - Interactive Functionality
...
class MorphFluxApp {
        ...
        reader.onload = (e) => {
            ...
            previewContainer.innerHTML = `
                ...
                <div class="preview-info">
                    ...
                    <button class="btn btn--primary btn--sm" onclick="morphFlux.startTransformation()">Start Transformation</button>
                </div>
            `;
    ...
    startTransformation() {
        this.showNotification('Transformation started! This is a demo - no actual processing occurs.', 'info');
        setTimeout(() => {
            this.closeModal();
        }, 2000);
    }
...
window.morphFlux = {
    startTransformation: () => morphFlux?.startTransformation()
};
